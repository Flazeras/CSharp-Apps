...
namespace CalculatorApp
{
    public partial class Calculator : Form
    {
        ...
        //This method fires when the form loads
        ...
        //When the user tries to to resize the form this method is called
        ...
        //Math stuff (return and set the actual size of the button)
        ...
        float num1, num2, result; //number1, number2 and the result
        char operation; //divide, multiply, plusMinus etc
        bool dec = false; //decimal
        
        //Method that changes the label and updates it for the user
        private void changeLabel(int numPressed)
        {
            //If its a decimal
            if (dec == true)
            {
                int decimalCount = 0; //A user cannot enter multiple decimals
                ...
                dec = false;
            } //if its not a decimal
            else
            {
                //if 0 is the current value on the display label AND its not null THEN
                //we want to take the number that was passed in and we want to update
                //the display label
        ...
        {
            result = 0;
            //if there is acutally some real content inside our calculator
